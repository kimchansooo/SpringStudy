...
//dto 담아라 ....
//class data {private int a, b, c, d, f ....}
...
//@Repository //DAO DB 작업 저장소 >> xml >> <context-scan base-package="com.model" />
public class MemberDAOImpl implements MemberDAO{
	
	//MemberDAOImpl은 template 객체를 필요로 한다 -> MemberDAOImpl은 template 객체를 사용하기 위해 template 객체의 주소값 필요하다 -> 주소(컨테이너 안에 있다.)를 주입
	/*
